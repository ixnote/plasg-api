...
export class MdaController {
  constructor(private mdaService: MdaService) {}
  ...
  @UseFilters(ExceptionsLoggerFilter)
  async assignAdmin(
    @Param() param: AssignMdaDto,
    @Body() body: { admin: string },
  ) {
    param.admin = body.admin;
  ...
  async addMdaTeamMember(
    @Param() param: GetMdaDto,
    @Body() body: AddTeamMembersDto,
  ) {
